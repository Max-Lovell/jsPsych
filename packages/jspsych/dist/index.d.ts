...
declare class KeyboardListenerAPI {
  ...
  constructor(
    ...
    areResponsesCaseSensitive?: boolean,
    minimumValidRt?: number
  );
  private listeners;
  private heldKeys;
...
declare class MediaAPI {
  ...
  preloadAudio(
    ...
    callback_load?: (filepath: string) => void,
...
declare function createJointPluginAPIObject(
  jsPsych: JsPsych
): KeyboardListenerAPI & TimeoutAPI & MediaAPI & SimulationAPI;
...
declare function shuffleNoRepeats(
  arr: Array<any>,
  equalityTest: (a: any, b: any) => boolean
): any[];
...
declare function sampleExGaussian(
  mean: number,
...
declare namespace turk {
  export { turk_turkInfo as turkInfo, turk_submitToTurk as submitToTurk };
}
...
declare namespace utils {
  export { utils_unique as unique, utils_deepCopy as deepCopy, utils_deepMerge as deepMerge };
}
