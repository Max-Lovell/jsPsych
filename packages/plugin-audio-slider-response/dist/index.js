...
class AudioSliderResponsePlugin {
  constructor(jsPsych) {
    ...
    this.setupTrial = () => {
      ...
      if (!this.params.response_allowed_while_playing) {
        this.display.querySelector("#jspsych-audio-slider-response-response").disabled = true;
        this.display.querySelector("#jspsych-audio-slider-response-next").disabled = true;
      }
      if (this.params.require_movement) {
        const enable_button = () => {
          this.display.querySelector("#jspsych-audio-slider-response-next").disabled = false;
        };
        this.display
