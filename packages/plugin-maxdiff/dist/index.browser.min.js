    ...
    trial(i, t) {
      ...
      (e +=
        ...
        ["left", "right"].forEach((m) => {
          document.getElementsByName(m).forEach((o) => {
            o.addEventListener("click", () => {
              var p = o.name == "left" ? "right" : "left",
                c = document.getElementsByClassName(o.className).namedItem(p);
              if ((c.checked && (c.checked = !1), t.required)) {
        ...
        i.querySelector("#jspsych-maxdiff-form").addEventListener("submit", (m) => {
          m.preventDefault();
          ...
          var h = {
            ...
            response: { left: c("left"), right: c("right") },
          };
