    ...
    data: {
      response: {
        ...
        nested: {
          ...
          response: {
            type:
              jspsych.ParameterType.STRING |
              jspsych.ParameterType.INT |
              jspsych.ParameterType.FLOAT |
              jspsych.ParameterType.BOOL |
              jspsych.ParameterType.OBJECT,
          },
        },
      },
      rt: {
    ...
    trial(display_element, trial) {
      ...
      for (var i = 0; i < trial.questions.length; i++) {
        ...
        html +=
          ...
          '">';
        html +=
          '<p class="jspsych-survey-multi-choice-text survey-multi-choice">' + question.prompt;
